...
import com.example.vpapp.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String usersucceslogin = getIntent().getStringExtra("ID AGEN");
        ...
        TextView navUsername = (TextView) headerView.findViewById(R.id.editTextTextPersonName);
